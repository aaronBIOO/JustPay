...
function Navigation() {
    ...
    return (
        ...
        {/* --- Mobile Bottom Navigation Bar --- */}
            ...
            <div className='hidden md:flex md:flex-col md:w-60 md:h-[85vh] bg-brand-white shadow-nav-bar/20 text-brand-black p-4 md:ml-4 items-center rounded-xl mt-auto'>
